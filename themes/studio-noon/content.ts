...
const en: Dict = {
  ...
  hero: {
    ...
    line2: 'LIGHT',
    intro:
      'STUDIO NOON is a small design practice building brands, websites and motion for the clear-headed and the bold.',
    ...
    projects: [
      {
        ...
        year: '2025',
        desc: 'A restless identity system for a slow-coffee roaster.',
      ...
      },
      {
        ...
        category: 'Web · Motion',
        year: '2025',
        desc: 'Editorial site + kinetic launch film for a mapping tool.',
      ...
      },
      {
        ...
        year: '2024',
        desc: 'Cover art and campaign for an experimental music label.',
      ...
      },
      {
        ...
        category: 'Brand · Web',
        year: '2024',
        desc: 'A publication and reading platform for design writing.',
      ...
      },
      {
        ...
        category: 'Motion',
        year: '2023',
        desc: 'Title sequence and toolkit for a climate documentary.',
      ...
      },
      {
        ...
        year: '2023',
        desc: 'Identity for a self-published studio radio & mix series.',
  ...
  services: {
    ...
    heading: 'Services',
    items: [
      { title: 'Brand Identity', body: 'Naming, logo systems, type & the rules that hold it together.' },
      { title: 'Web Design & Dev', body: 'Sites you can actually ship — designed and built end to end.' },
      { title: 'Motion', body: 'Launch films, loops and interface motion with a pulse.' },
      { title: 'Art Direction', body: 'Photo, image and campaign direction across every touchpoint.' },
    ],
  },
  process: {
    label: 'How we work',
    heading: 'Process',
    steps: [
      { title: 'Listen', body: 'We start with a real conversation, not a template.' },
      { title: 'Sketch', body: 'Fast, ugly, honest exploration to find the idea.' },
      { title: 'Build', body: 'We design and engineer in the same room.' },
      { title: 'Ship', body: 'Launch, measure, and keep sharpening.' },
    ],
  },
  studio: {
    label: 'About',
    heading: 'A small studio that punches up',
    body:
      'Founded in 2018, STUDIO NOON is a tight team of designers and makers. We take on a handful of projects a year so each one gets the whole room — no juniors doing the real work in a back office.',
    stats: [
  ...
  contact: {
    label: 'Contact',
    line: "Let's make something",
    email: 'hello@studionoon.kr',
    note: 'New projects, collaborations, or a coffee — the door is open.',
  },
  footer: {
    tagline: 'Made in the noon light.',
